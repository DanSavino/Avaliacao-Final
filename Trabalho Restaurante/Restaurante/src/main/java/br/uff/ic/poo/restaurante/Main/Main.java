...
import br.uff.ic.poo.restaurante.Excecoes.ItemJaExistenteException;
import br.uff.ic.poo.restaurante.Excecoes.ItemNaoEncontradoException;
...
public class Main {
    ...
    public static void main(String[] args) throws ItemJaExistenteException, ItemNaoEncontradoException{
